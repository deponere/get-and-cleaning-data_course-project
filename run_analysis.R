...
print(" Ask 5 is done....")
write.table(Ask1,"./data/ask1.txt",row.name=FALSE )
write.table(Ask2,"./data/ask2.txt",row.name=FALSE )
write.table(Ask3,"./data/ask3.txt",row.name=FALSE )
write.table(Ask4,"./data/ask4.txt",row.name=FALSE )
write.table(Ask5,"./data/ask5.txt",row.name=FALSE )
